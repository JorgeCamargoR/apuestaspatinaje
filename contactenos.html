...
<span style="display: none;" class="ir-arriba icon-arrow-up2"><p>Subir</p></span>
	...
	<div class="header" id="header">
      ...
      <div class="col-lg-3 col-lg-offset-1 visible-lg">
        <a href="../index.php" title="Club de Patinaje Apuestas El Pueblo"><img src="../img/logo.png" alt="CLUB DE PATINAJE APUESTAS EL PUEBLO" width="74%" class="img-responsive" ></a>
      </div>
      ...
      <div class="col-lg-1 visible-lg"></div>
        ...
        <a href="../index.php" title="Club de Patinaje Apuestas El Pueblo"><img src="../img/logo.png" alt="CLUB DE PATINAJE APUESTAS EL PUEBLO" width="38%" class="logo"></a>
      </div>
      ...
      <h1 class="nombreapuestas"><strong>Bienvenidos al Club Escuela de patinaje Apuestas el Pueblo</strong></h1>
        ...
        <a href="../index.php" title="Club de Patinaje Apuestas El Pueblo"><img src="../img/logo.png" alt="CLUB DE PATINAJE APUESTAS EL PUEBLO" width="20%" class="logo"></a>
      </div>
...
<nav role="navigation" class="navbar navbar-default">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <!--<a href="https://www.facebook.com/Club-de-Patinaje-Apuestas-el-Pueblo-1643692445865527" class="btn btn-social-icon btn-lg btn-facebook ">
     <span id="social" class="fa fa-facebook-square fa-2x social-fb"></span>
     </a>
     <a href="https://www.youtube.com/channel/UCZ68wMshlEeVDemMmrItbZA" class="btn btn-social-icon btn-lg btn-youtube" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul role="navigation" class="nav navbar-nav">
        ...
        <li>
        <a class="visible-xs visible-sm visible-md" href="../index.php" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" >
        INICIO <span class="sr-only">(current)</span>
        </a>

         <a class="visible-lg" href="../index.php">
         INICIO <span class="sr-only">(current)</span>
         </a>
        </li>

        <li>
        <a class="visible-lg" id="quienessomos" href="quienessomos.php">
        QUIÉNES SOMOS</a>

        <a class="visible-sm visible-md visible-xs" id="historia" href="quienessomos.php" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        QUIÉNES SOMOS</a>

        </li>

        <li>
        <a class="visible-lg " id="historia" href="historia.php">
        HISTORIA</a>

       <a class="visible-sm visible-md visible-xs" id="historia" href="historia.php" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
       HISTORIA</a>
      
       </li>
        
         <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ESCUELA DE FORMACIÓN<span class="caret"></span></a>
         <ul class="dropdown-menu">
         <li>
           <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="escuela-de-formacion.php">Básico
            </a>
         <a class="visible-lg" href="escuela-de-formacion.php">Básico</a>
         </li>
         <li>
           <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="escuela-de-formacion.php">Avanzado
            </a>
         <a class="visible-lg" href="escuela-de-formacion.php">Avanzado</a>
         </li>
         <li>
           <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="escuela-de-formacion.php" title="Adultos">Adultos
            </a>
         <a class="visible-lg" href="escuela-de-formacion.php" title="Adultos">Adultos</a>
         </li>
         </ul>
         </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="carreras.php">Pre-liga
            </a>

            <a class="visible-lg" href="carreras.php" >Pre-liga
            </a>

            </li>

            <li>
             <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="carreras.php" >Federados
            </a>

            <a class="visible-lg" href="carreras.php">Federados</a>
            </li>
 ...
 <li>
          <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="fotos.php" >FOTOS
            </a>
         <a class="visible-lg" href="fotos.php">FOTOS</a>
         </li>

         <li>
          <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="videos.php" >VIDEOS
            </a>
         <a class="visible-lg" href="videos.php">VIDEOS</a>
         </li>

         <li>
          <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="contactenos.php" >CONTÁCTENOS
            </a>
            <a class="visible-lg" href="contactenos.php">CONTÁCTENOS</a>
         </li>
         <li>
                    <a class="visible-xs visible-sm visible-md" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" href="tienda.php" title="Accesorios Deportivos Ramírez Sierra" >
                        <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>
                    <a class="visible-lg" href="tienda.php" title="Accesorios Deportivos Ramírez Sierra"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>
                </li>
      </ul>
   <!--
...
<!--Contenido-->
 ...
 <div id="titulosecciones" >
        <h2 style="text-align: center;margin:0px;padding:15px; font-weight: bold">CONTÁCTENOS</h2>
  ...
  <div class="container-fluid" id="abajofooter" >
         ...
         <div class="col-xs-12 col-md-4 col-lg-4" id="footer1">
              <ul class="col-xs-6 col-md-6 col-lg-6" id="menufooter">
                 ...
                 <li><a href="../index.php"><h6>INICIO</h6></a></li>
                 <li><a href="quienessomos.php"><h6>QUIÉNES SOMOS</h6></a></li>
                 <li><a href="historia.php"><h6>HISTORIA</h6></a></li>
              </ul>

              <ul class="col-xs-6 col-md-6 col-lg-6" id="menufooter">
                  <li><a href="escuela-de-formacion.php"><h6>ESCUELA DE FORMACIÓN</h6></a></li>
                 <li><a href="carreras.php"><h6>CARRERAS</h6></a></li>
                  <li><a href="fotos.php"><h6>FOTOS</h6></a></li>
                  <li><a href="videos.php"><h6>VIDEOS</h6></a></li>
              </ul>
        </div>

        <div class="col-xs-6 col-md-4 col-lg-4" id="footer2">
        <a style="text-decoration: none; color:white;" href="contactenos.php"><h5><strong>CONTÁCTENOS</strong></h5></a>
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12" id="footerfinal">
               ...
               <div class="col-xs-12 visible-xs" style="text-align:center">
                                                    <a href="../index.php" title="Club de Patinaje Apuestas el Pueblo">

                  <img src="../img/logo.png" alt="CLUB APUESTAS EL PUEBLO" width="25%" >
                 </a> <h6>&copy 2016 <strong>CLUB DE PATINAJE APUESTAS EL PUEBLO</strong></h6>
               </div>
...
<img src="../img/logo.png" alt="CLUB APUESTAS EL PUEBLO" width="15%" >
               ...
               <div class="col-lg-12 visible-lg" style="text-align:center">
                 ...
                 </a><h4>&copy 2016<strong> CLUB DE PATINAJE APUESTAS EL PUEBLO</strong></h4>
               </div>
